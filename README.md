...
This repo contains sample code for a simple chat webapp that integrates with Azure OpenAI. Note: some portions of the app use preview APIs. This README change also serves as a lightweight deployment trigger.
...
|UI_ARTICLE_URL_PREFIX|No||Base URL prepended to article IDs to convert relative citation links (e.g. `https://contoso.com/#/articles/`)
